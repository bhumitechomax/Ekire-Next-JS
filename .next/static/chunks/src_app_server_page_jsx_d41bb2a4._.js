(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_server_page_jsx_d41bb2a4._.js", {

"[project]/src/app/server/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Server() {
    ...
    const [serverId, setserverId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Server.useEffect": ()=>{
            ...
            if (token) {
                ...
                const FetchServer = {
                    "Server.useEffect.FetchServer": async ()=>{
                        console.log(`Bearer ${token}`);
                        setIsLoading(true);
                        try {
                            const response = await fetch(`${("TURBOPACK compile-time value", "http://staging.ekire.net/api")}/customer/server/list`, {
                                method: "POST",
                                headers: {
    ...
    const confirmDelete = (serverId)=>{
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                swalWithBootstrapButtons.fire('Cancelled', 'Your Server is safe :)', 'error');
            }
        });
    };
    const handleDelete = async (serverId, swalInstance)=>{
        if (!serverId) return;
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "http://staging.ekire.net/api")}/server/${serverId}/destroy`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
            ...
            if (res.ok && result?.data?.status === 'success') {
                swalInstance.fire('Deleted!', 'Your server has been deleted.', 'success').then(()=>{
            ...
            swalInstance.fire('Error!', 'An error occurred while deleting the server.', 'error');
            console.error(err);
        }
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Server.useEffect": ()=>{
            ...
            const timer = setTimeout({
                "Server.useEffect.timer": ()=>{
                    setIsLoading(false);
                }
            }["Server.useEffect.timer"], 900);
            return ({
                "Server.useEffect": ()=>clearTimeout(timer)
            })["Server.useEffect"];
        }
    }["Server.useEffect"], []);
    // to load datatable
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                                children: Array.isArray(servers) && servers.map((server, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                                children: server.status == "active" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                    ...
                                                                                    className: "badge bg-danger-subtle text-danger text-uppercase",
                                                                                    children: server.status
                                                                                }, void 0, false, {
                                                                                    fileName: "[project]/src/app/server/page.jsx",
                                                                                    lineNumber: 224,
...
_s(Server, "9UhvwpXXFRI5bMiwHlvC9rFjWqk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = Server;
const __TURBOPACK__default__export__ = Server;
var _c;
__turbopack_context__.k.register(_c, "Server");
...
//# sourceMappingURL=src_app_server_page_jsx_d41bb2a4._.js.map