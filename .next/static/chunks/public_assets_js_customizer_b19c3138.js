(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/public_assets_js_customizer_b19c3138.js", {

"[project]/public/assets/js/customizer.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
/*Handle click for Sidebar option, layout option and Text size*/ $(document).on("click", ".offcanvas-body > ul > li", function() {
    $(this).parent().find("li").removeClass('selected');
    $(this).addClass('selected');
});
/* Theme name prepend to localstorage key*/ const themeName = "La-Theme";
/* Set item in local store */ function getLocalStorageItem(key, defaultValue = null) {
    return localStorage.getItem(`${themeName}-${key}`) ?? defaultValue;
}
/* Get item in local store */ function setLocalStorageItem(key, value) {
...
//# sourceMappingURL=public_assets_js_customizer_b19c3138.js.map