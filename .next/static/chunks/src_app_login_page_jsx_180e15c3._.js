    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (res.ok && result.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].set("email", result.data.user.email, {
                    expires: 7
                });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Login.useEffect": ()=>{
            if (error || success) {
                ...
                }["Login.useEffect.timer"], 10000); // Disable after 10 seconds
                return ({
                    "Login.useEffect": ()=>clearTimeout(timer)
                })["Login.useEffect"]; // Clean up the timer if component is unmounted
            }
        }
    }["Login.useEffect"], [
        error,
...
_s(Login, "j7G2gw5jY3eXqXRls8CpHy1vpNQ=", false, function() {
    return [
