...
function Login() {
    ...
    const handleLogin = async (e)=>{
        ...
        // };
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "http://staging.ekire.net/api")}/auth/login`, {
                method: "POST",
                headers: {
            ...
            if (res.ok && result.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set("email", result.data.user.email, {
                    expires: 7
                });
