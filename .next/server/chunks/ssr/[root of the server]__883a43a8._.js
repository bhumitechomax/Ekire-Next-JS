...
"[project]/public/assets/js/customizer.js [app-ssr] (ecmascript, async loader)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/public_assets_js_customizer_7c0e7cb1.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/public/assets/js/customizer.js [app-ssr] (ecmascript)");
    });
});
}}),
