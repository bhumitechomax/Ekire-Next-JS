                                                                                        ...
                                                                                        <div className="device-menu-item" draggable="false">
                                                                                            <span className="device-menu-img">
                                                                                                <img
                                                                                                    ...
                                                                                                    width={32}
                                                                                                    height={20}
                                                                                                    className={`transition-all duration-300 ${selectedServerId === server.id ? "grayscale-0" : "grayscale"
                                                                                                        }`}
                                                                    ...
                                                                    <div className="row simple-pricing-container app-arrow">
                                                                        {os?.map((o, index) => (
                                                                            <div className="col-md-6 col-xl-3 p-3" key={o.id}>
                                                                                ...
                                                                                {selectedOSId === o.id && (
                                                                                    <div className="app-form row g-3 needs-validation mt-0" noValidate>
                                            ...
                                            <div className="card">
                                                ...
                                                <div className="card-body">
                                                    <div className="table-responsive ps-3">
                                                        ...
                                                        <br /> 
                                                        <div className="cart-gift text-end mt-4">
                                                            <button className="btn btn-primary rounded">Deploy Server</button>
                                                        </div>
                                                    </div>
                                                </div>
