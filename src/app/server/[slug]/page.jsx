                          ...
                          <div className="card-body">
                            <div className="row d-flex align-items-center justify-content-between">
                              ...
                              >
                                ...
                                <Link
                                  href={{
                                    pathname: "/server/upgrade_plan",
                                    query: { serverId: server.id }, // send serverId as query param
                                  }}
                                  className="btn btn-primary h-45 icon-btn mb-3"
                                  style={{ width: "fit-content" }}
                                >
                                  <i className="ph-bold ph-arrow-up f-s-18" />{" "}
                                  Upgrade
                                </Link>
                        ...
                        <div className="card security-card-content">
                          ...
                          <div className="card-body d-flex gap-3">
                            <button className="btn h-45 icon-btn mb-3">
                              <i className="ph-fill  ph-eye f-s-18" /> View
                              Backup
                            </button>
                            <button className="btn btn-primary h-45 icon-btn mb-3">
