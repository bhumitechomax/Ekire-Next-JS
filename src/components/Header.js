                        ...
                        <div className="row row-cols-3">
                          ...
                          <div className="d-flex-center text-center mb-3">
                            <a href="project_app.html" target="_blank">
                              ...
                              <p className="mb-0 f-w-500 text-warning">
                                Project
                              </p>
                            </a>
                          </div>
                          <div className="d-flex-center text-center mb-3">
                            <a href="invoice.html" target="_blank">
                              ...
                              <p className="mb-0 f-w-500 text-secondary">
                                Invoice
                              </p>
                            </a>
                          </div>
                          ...
                          <div className="d-flex-center text-center mb-3">
                            <a href="profile.html" target="_blank">
                              ...
                              <p className="mb-0 f-w-500 text-primary">
                                Profile
                              </p>
                            </a>
                          </div>
                          <div className="d-flex-center text-center mb-3">
                            <a href="gallery.html" target="_blank">
                              ...
                              <p className="mb-0 f-w-500 text-success">
                                Gallery
                              </p>
                            </a>
                          </div>
                          ...
                          <div className="d-flex-center text-center mb-3">
                            <a href="filemanager.html" target="_blank">
                              ...
                              <p className="mb-0 f-w-500 text-danger">
                                File Ma..
                              </p>
                            </a>
                          </div>
                        ...
                        <div className="head-container notification-head-container">
                          ...
                          <div className="notification-message head-box">
                            ...
                            <div className="message-content-box flex-grow-1 ps-2">
                              ...
                              <span className="badge text-light-warning mt-2">
                                {" "}
                                45 min
                              </span>
                            </div>
                          ...
                          <div className="hidden-massage py-4 px-3">
                            ...
                            <div>
                              ...
                              <p className="text-secondary">
                                When you have any notifications added here,will
                                appear here.
                              </p>
                            </div>
                          </div>
                        ...
                        <ul>
                          ...
                          <li>
                            <a
                              ...
                              target="_blank"
                            >
                              <i className="iconoir-eye-closed pe-1 f-s-20" />{" "}
                              Hide Settings
                            </a>
                          </li>
                          <li>
